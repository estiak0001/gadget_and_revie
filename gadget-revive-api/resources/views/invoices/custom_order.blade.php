                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="bold">
                            ...
                            <div class="item-sub"><strong>SL / SKU:</strong> {{ $item['item_sku'] }}</div>
                            @endif
                            @if(!empty($item['notes']))
                            <div class="item-sub"><strong>Note:</strong> {{ $item['notes'] }}</div>
                            @endif
                        </td>
                        <td class="r">BDT {{ number_format($item['unit_price'], 2) }}</td>
                        <td class="c">{{ $item['quantity'] }}</td>
                        <td class="r bold">BDT {{ number_format($item['total_price'], 2) }}</td>
                    </tr>
                    @empty
                    <tr>

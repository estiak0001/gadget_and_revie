...
export default function HomeClient() {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Visually hidden — the promo carousel above supplies the visible hero copy (and it
          rotates per-slide, so it can't double as the page's one true heading). This is the
          single on-page signal of what gadgetandrevive.com's homepage is actually about, for
          both search engines and screen readers. */}
      <h1 className="sr-only">
        Gadget &amp; Revive — Genuine Computer &amp; Laptop Parts, Repairs and IT Services in Dhaka
      </h1>
